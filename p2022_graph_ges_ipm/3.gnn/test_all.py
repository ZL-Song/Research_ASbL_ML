...
if __name__ == '__main__':
    ...
    d1_pred = numpy.squeeze(d1_pred.cpu().detach().numpy(), axis=1)
    d2_pred = numpy.squeeze(d2_pred.cpu().detach().numpy(), axis=1)
    
    numpy.save("./model_pred/d1_pred.npy", d1_pred)
    numpy.save("./model_pred/d2_pred.npy", d2_pred)
